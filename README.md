...
- **Version Support**: Clone specific Aztec release tags (e.g., `v5.0.0-rc.1`)
...
| `AZTEC_DEFAULT_VERSION` | `v5.0.0-rc.1`                        | Default version tag for `aztec_sync_repos`.                                                                         |
...
- `version` (string): Aztec version tag to clone (e.g., `v5.0.0-rc.1`). Defaults to latest supported version.
...
```
aztec_sync_repos({ version: "v5.0.0-rc.1" })
```
